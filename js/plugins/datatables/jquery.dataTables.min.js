...
sEmptyTable:"Pas de données dans la table",sInfo:"voir _START_ sur _END_ des _TOTAL_ entrées",sInfoEmpty:"Voir 0 à 0 pour 0 entrées",sInfoFiltered:"(filtré sur _MAX_ total entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Voir _MENU_ entrées",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Recherce:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
